...
import com.example.guard_patrol.databinding.CustomTaskSopBinding

class AdapterTaskSop : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding = CustomTaskSopBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CustomDetailViewHolder(private val binding : CustomTaskSopBinding) : RecyclerView.ViewHolder(binding.root){
